...
class APIcontroller extends Controller
{
	...
	{
		$city=$req->city;
		$url ="http://api.openweathermap.org/data/2.5/forecast?q=$city&APPID=b9646a423fa11fa2b298623b3082337e";
		$arr=file_get_contents($url);
		$apiret=json_decode($arr);
		$city_id=$apiret->city->id;
		$url ="http://api.openweathermap.org/data/2.5/weather?id=$city_id&lang=en&units=metric&APPID=b9646a423fa11fa2b298623b3082337e";
		$arr=file_get_contents($url);
		$apiret=json_decode($arr);
